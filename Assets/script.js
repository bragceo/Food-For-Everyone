...
// Function to get menue results from yelp 
function searchYelp(query) {
  const apiKey = 'zx1VZlQltbz1kB0xXAhJkdkPlKlwxvxlaj_g2QPEv6H5rLPkkccl6fs2LXUws5vZQZYnF4PADaO7BFeUDqfkDqvsvwvAAtBOCq-gUSIdbpcxXeJWNcL4BxDqAx8FZHYx';
  const url = `https://api.yelp.com/v3/businesses/search?term=${query}&location=New+York`;
  ...
  .then(data => {
    console.log(data.businesses); // Replace with your own code to handle the response data
  })
